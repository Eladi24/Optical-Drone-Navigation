...
# path lightglue_onnx/lightglue.py -- Apache-2.0 (LICENSE confirmed at that tag). See disk.py's
# header in this same directory for why this is vendored rather than pip-installed.
