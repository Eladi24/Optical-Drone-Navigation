# Vendored verbatim from ignacio-rocco/ncnet (MIT license), lib/conv4d.py,
# for STRATEGY.md Phase 2+ Option A2 (dense DINOv2 features + neighbourhood-
# consensus 4D-conv, the arXiv:2506.09748 direction). Only the Conv4d module is
# used here; the rest of that repo (its own ResNet backbone, training harness)
# is not vendored. Kept byte-for-byte so it can be diffed against upstream.
#
# Upstream: https://github.com/ignacio-rocco/ncnet  (MIT)
import math
import torch
